...
#[ApiResource(
    operations: [
        ...
        new Patch(
            security: "is_granted('ROLE_EDITOR') or (is_granted('ROLE_AUTHOR') and object.getCreatedBy() == user)",
            securityMessage: "Seul un éditeur, administrateur ou l'auteur du film peut le modifier."
        ),
        new Delete(
