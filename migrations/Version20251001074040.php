 ...
 */
final class Version20251001074040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie ADD director_id INT DEFAULT NULL, ADD url VARCHAR(255) DEFAULT NULL, ADD budget VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie DROP director_id, DROP url, DROP budget');
    }
}
